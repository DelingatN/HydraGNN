...
srun --export=ALL,HYDRAGNN_DIAG=1,HYDRAGNN_DIAG_RANK=1 \
  ...
  python -u train_opf_solution_heterogeneous.py --num_groups 1 --preonly --hdf5 --modelname "case2000" --data_root "/lustre/orion/lrn070/proj-shared/ndelingat/HydraGNN/examples/opf/dataset/" --case_name  \
  pglib_opf_case2000_goc #pglib_opf_case4661_sdet pglib_opf_case6470_rte pglib_opf_case10000_goc pglib_opf_case13659_pegase
